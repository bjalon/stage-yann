const t = new Set, e = new Set,
    ...
    h = () => t.has("a") || t.has("ArrowLeft") || e.has(14), n = () => t.has("d") || t.has("ArrowRight") || e.has(15);
document.addEventListener("keydown", e => {
    t.add(e.key), s.has(e.key) && e.preventDefault()
}), document.addEventListener("keyup", ({key: e}) => {
    t.delete(e)
});
const o = new Map, r = (t, e) => {
...
var x = 440 * Math.pow(Math.pow(2, 1 / 12), -9), q = /^[0-9.]+$/, k = /\s+/, B = /(\d+)/, A = {};
...
E.getFrequency = function (t) {
    var e = t.split(B), s = A[e[0]], i = (e[1] || 4) - 4;
...
D.prototype.createFxNodes = function () {
    ...
    var s = 60 / this.tempo * this.notes[t].duration, i = s * (1 - (this.staccato || 0));
    ...
    var i = this.getNextNote(t), h = this.getSlideStartDelay(s);
...
I();
const O = new D(G, 320, ["Bb3 e", "G5 e", "Bb4 e"]), J = new D(G, 400, ["Bb6 e", "D6 e"]),
    P = new D(G, 400, ["D6 e", "Bb6 e"]), W = new D(G, 280, ["C4 s", "G4 s", "C5 h"]),
...
const Q = 3, Z = document.getElementById("editor"), tt = Z.createSVGPoint(),
    et = ({clientX: t, clientY: e}) => (tt.x = t, tt.y = e, tt.matrixTransform(Z.getScreenCTM().inverse()));
let st = null, it = null;
...
class at extends l {
    ...
    addBar(t) {
        this.bars.push(t), this.append(t), t.element.addEventListener("click", ({shiftKey: e}) => {
            e && (t.remove(), this.bars = this.bars.filter(e => e === t))
        })
    }

    addSpike(t) {
        this.spikes.push(t), this.append(t), t.element.addEventListener("click", ({shiftKey: e}) => {
...
const dt = new class {
    constructor() {
        this.title = new v(this), this.controls = new Y(this), this.scene = new ct(this, c), this.editor = new at([[[100, 300], [500, 300], [[84, 361, 362, 48, 1]], [[446, 401, 176, 8, 1, "up"]]]], this), this.dialog = document.getElementById("dialog"), r(1, this.toggle.bind(this)), document.addEventListener("keydown", this.keydown.bind(this))
    }
